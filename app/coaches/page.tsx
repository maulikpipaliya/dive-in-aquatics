...
export const metadata: Metadata = {
  title: 'Coaches',
  description: 'Meet our certified swimming coaches with years of experience in teaching all age groups. Professional, patient, and passionate about swimming.',
  alternates: {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our certified coaches bring years of experience, passion, and dedication to help you achieve your swimming goals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {COACHES.map((coach) => (
            <Card key={coach.name} className="text-center hover:shadow-xl transition-shadow">
              <CardHeader>
                <div className="w-32 h-32 mx-auto mb-4 bg-gradient-to-br from-brand-blue-light to-brand-blue rounded-full flex items-center justify-center">
        ...
        <div className="mt-16 bg-gray-50 rounded-lg p-8 md:p-12 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div>
              <h3 className="text-xl font-semibold mb-2 text-brand-blue">Certified & Experienced</h3>
              <p className="text-gray-600">
                All our coaches hold recognized certifications and have extensive teaching experience.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                We understand every student learns at their own pace and provide personalized attention.
              </p>
            </div>
            <div>
